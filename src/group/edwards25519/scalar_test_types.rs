...
use crate::{encoding::{Marshaling, BinaryMarshaler, BinaryUnmarshaler, self}, cipher::Stream};
...
lazy_static! {
    ...
    pub static ref MINUS_ONE: Scalar = Scalar::default().set_bytes(&[0xec, 0xd3, 0xf5, 0x5c, 0x1a, 0x63, 0x12, 0x58, 0xd6, 0x9c, 0xf7, 0xa2, 0xde, 0xf9, 0xde, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10]);
}
