...
pub trait Suite<S: Scalar, P: Point>: Group<S, P> + /* HashFactory + */ XOFFactory + Random {}
...
pub fn NewDealer<SCALAR, POINT, SUITE, STREAM>(
    suite: SUITE,
    longterm: SCALAR,
    secret: SCALAR,
    verifiers: Vec<POINT>,
...
struct Aggregator<SUITE, POINT, SCALAR>
where
    SCALAR: Scalar,
    SUITE: Suite<SCALAR, POINT>,
    POINT: Point,
...
fn validT(t: usize, verifiers: Vec<impl Point>) -> bool {
