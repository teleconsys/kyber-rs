...
use crate::{Group, group::{HashFactory, ScalarCanCheckCanonical, PointCanCheckCanonicalAndSmallOrder}, Random, share::{poly::{PriShare, PubPoly, self}}, Point, encoding::Marshaling, sign::{eddsa, schnorr}, Scalar};
...
pub fn new_dss<SUITE: Suite, DKS: DistKeyShare<SUITE::POINT>>(suite: SUITE, secret: &<SUITE::POINT as Point>::SCALAR, participants: &[SUITE::POINT],
	long: &DKS, random: &DKS, msg: &[u8], t: usize) -> Result<DSS<SUITE, DKS>> {
